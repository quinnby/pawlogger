...
namespace CarCareTracker.Helper
{
    ...
    public static class StaticHelper
    {
        ...
        public const string ReportNote = "Report generated by PawLogger, a Free and Open Source Pet Health Tracker";
        ...
        public static string GetVehicleIdentifier(Vehicle vehicle)
        {
            ...
            if (!string.IsNullOrWhiteSpace(vehicle.MicrochipNumber))
                return vehicle.MicrochipNumber;
            if (!string.IsNullOrWhiteSpace(vehicle.LicenseNumber))
