...
namespace CarCareTracker.Controllers
{
    public partial class APIController
    {
        ...
        {
            MarkContractUsage("/api/vehicle/servicerecords/all");
        ...
        [HttpGet]
        [Route("/api/v2/profiles/servicerecords/all")]
        public IActionResult AllServiceRecordsV2(MethodParameter parameters) => AllServiceRecords(parameters);

        [TypeFilter(typeof(CollaboratorFilter))]
        [HttpGet]
        [Route("/api/vehicle/servicerecords")]
        public IActionResult ServiceRecords(int vehicleId = default, MethodParameter? parameters = null, int petProfileId = default)
        {
            MarkContractUsage("/api/vehicle/servicerecords");
            parameters ??= new MethodParameter();
            var resolvedVehicleId = ResolveVehicleIdAlias(vehicleId, petProfileId, "/api/vehicle/servicerecords");
            ...
            var vehicleRecords = _serviceRecordDataAccess.GetServiceRecordsByVehicleId(resolvedVehicleId);
            if (parameters.Id != default)
            {
                vehicleRecords.RemoveAll(x => x.Id != parameters.Id);
            }
        ...
        [TypeFilter(typeof(CollaboratorFilter))]
        [HttpGet]
        [Route("/api/v2/profiles/servicerecords")]
        public IActionResult ServiceRecordsV2(int petProfileId = default, MethodParameter? parameters = null, int vehicleId = default)
            => ServiceRecords(vehicleId, parameters, petProfileId);
