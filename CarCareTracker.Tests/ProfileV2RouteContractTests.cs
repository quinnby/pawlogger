...
public class ProfileV2RouteContractTests
{
    ...
    [InlineData(nameof(APIController.AddNote), "/api/vehicle/notes/add")]
    [InlineData(nameof(APIController.AddNoteV2), "/api/v2/profiles/notes/add")]
    [InlineData(nameof(APIController.UpdateNote), "/api/vehicle/notes/update")]
    [InlineData(nameof(APIController.UpdateNoteV2), "/api/v2/profiles/notes/update")]
    [InlineData(nameof(APIController.DeleteNote), "/api/vehicle/notes/delete")]
    [InlineData(nameof(APIController.DeleteNoteV2), "/api/v2/profiles/notes/delete")]
